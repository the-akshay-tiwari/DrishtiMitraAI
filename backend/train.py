...
def main() -> None:
    ...
    report = {
        ...
        "dataset": "Bundled IDRiD labels and fundus images",
        "split": {"training": len(training_samples), "validation": len(validation_samples), "held_out_test": len(test_samples)},
        "best_epoch": best_epoch,
        "best_validation_metrics": checkpoint["metrics"],
        "held_out_test_metrics": test_metrics,
        "held_out_test_class_counts": {str(grade): test_targets.count(grade) for grade in range(len(CLASS_NAMES))},
